    ...
    await resend.emails.send({
      ...
      html: `
        <div style="font-family: Arial, sans-serif; max-width: 480px; margin: 0 auto; background: #0A0A0A; color: #F5F3EE; padding: 40px; border-radius: 16px;">
          ...
          <p style="color: #aaa; margin-bottom: 24px;">Your store application has been reviewed and <strong style="color: #fff;">approved</strong>. You can now log in and start listing your products.</p>
          <div style="background: #1C1C1C; border-radius: 14px; padding: 24px; margin-bottom: 32px;">
            ...
            <p style="margin: 0 0 8px; color: #fff;">✅ Log in to your FitGo account</p>
            <p style="margin: 0 0 8px; color: #fff;">📦 Add your first products</p>
            <p style="margin: 0 0 8px; color: #fff;">🚀 Start receiving orders</p>
            <p style="margin: 0; color: #fff;">💰 Earn money with every delivery</p>
          </div>
          <p style="color: #555; font-size: 13px;">— The FitGo Team, Addis Ababa 🇪🇹</p>
        </div>
      `,
    });

    res.json({ message: 'Seller approved and notified', user });
  } catch (err) {
